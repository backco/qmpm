...
public class Automata {
	 ...
	 * @author Christoffer
	 * 
	 * Modified move() method which takes a given state and performs a move from
	 * there Also takes validMoves to avoid computing this twice
	 */
	...
	public List<String> BFS(State s) throws Exception {
		...
		while (!fringe.isEmpty()) {
			...
			// System.out.println("Fring size: " + fringe.size() + " Explored States size: "
			// + exploredStates.size());
		}
		return null;
	}
