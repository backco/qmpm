...
public class DCRTemplateFactory {
	...
	// Existence3 l: !e1(l), %!e2(l), %!e3(l), e1(l) -->+ e2(l), e1(l) -->% e1(l),
	// e2(l) -->+ e3(l), e2(l) -->% e2(l)
	...
	// Responded Existence l m: %e2(l), e1(l) *--> f(m), f(m) -->% e1(l), f(m) -->+
	// e2(l)
	...
	// Co-existence l m: %e2(l), %f2(m), e1(l) *--> f1(m), f1(m) *--> e1(l), e1(l)
	// -->% e1(l), f1(m) -->% f1(m), e1(l) -->+ e2(l), f1(m) -->+ f2(m)
