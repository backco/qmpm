...
public class Automaton {
	...
	/*
	 * Map<String, DCRMarking> states = new HashMap<String, DCRMarking>(); // unsure
	 * if we need to know the markings, but in case it is useful... Set<String>
	 * acceptingStates = new HashSet<String>(); Map<String, HashSet<String>> edges =
	 * new HashMap<String, HashSet<String>>(); Map<String, HashSet<String>>
	 * reverseEdges = new HashMap<String, HashSet<String>>(); // could be useful for
	 * implementing an A* type search?
	 */
	DCRGraph dcrgraph;
	...
	String currentState = "";
	// Map<Integer, HashSet<Integer>> reverseEdges = new HashMap<Integer,
	// HashSet<Integer>>();
	...
	private void Build() {
		...
		/*
		 * System.out.println("Automaton build: "); System.out.print("States: "); for
		 * (String s : states) { System.out.println(s + ";");
		 * System.out.println("Hashcode: " + s.hashCode()); if (s == currentState)
		 * System.out.println("INITIAL STATE"); System.out.println("Edges: "); for (Edge
		 * e : edges.get(s)) { System.out.print("===" + e.lbl + "===>");
		 * System.out.println(e.trg.hashCode()); } System.out.println("");
		 * 
		 * } System.out.println("");
		 */
	}
	...
	/*
	 * public Set<String> possibleMoves() { return dcrgraph.getAllEnabled(); }
	 * 
	 * public Set<String> preferredMoves() { Set<String> result = new
	 * HashSet<String>(dcrgraph.getIncludedPending());
	 * result.retainAll(dcrgraph.getAllEnabled()); return result; }
	 */
